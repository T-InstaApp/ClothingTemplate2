...
class UpdateOrderRequest(
    ...
    shipping_address_text: String, billing_address_text: String, complete_shipping_address: String
) {
    ...
    var complete_shipping_address: String
    ...
    init {
        ...
        this.complete_shipping_address = complete_shipping_address
    }
}